...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/svg-source-support.c.in")
  configure_file(src/svg-source-support.c.in svg-source-support.c @ONLY)
  add_library(svg-source-support STATIC)
  target_sources(
    svg-source-support
    PRIVATE svg-source-support.c
    PUBLIC src/svg-source-support.h)
  target_include_directories(svg-source-support PUBLIC "${CMAKE_CURRENT_SOURCE_DIR}/src")
  if(OS_LINUX
     OR OS_FREEBSD
     OR OS_OPENBSD)
    # add fPIC on Linux to prevent shared object errors
    set_property(TARGET svg-source-support PROPERTY POSITION_INDEPENDENT_CODE ON)
  endif()
endif()
