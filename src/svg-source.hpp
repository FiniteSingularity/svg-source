...
public:
	...
	static bool ScaleByChanged(obs_properties_t* props, obs_property_t* property, obs_data_t* settings);
	static bool InputTypeChanged(obs_properties_t* props, obs_property_t* property, obs_data_t* settings);
